            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <div class="relative hidden sm:block">
                        <input type="text" placeholder="Search plants..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
                ...
                <div>
                    <a href="login" class="text-gray-700 hover:bg-emerald-600 transition-colors border border-gray-300 rounded-2xl hover:text-green-200 px-4 py-2 cursor-pointer">Login</a>
                </div>
            </div>
        </div>
    </nav>