<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-emerald-900 to-gray-800 pt-16">
    <!-- Background decorative elements -->
    <div class="absolute inset-0 overflow-hidden">
        <div class="absolute top-20 left-10 w-32 h-32 leaf-decoration opacity-30"></div>
        <div class="absolute bottom-20 right-10 w-24 h-24 leaf-decoration opacity-20"></div>
        <div class="absolute top-1/2 left-5 w-16 h-16 leaf-decoration opacity-25"></div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="animate-slide-in-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <button class="group inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-emerald-600 hover:bg-emerald-700 rounded-full shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                    ...
                    <button class="group inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-white/10 hover:bg-emerald-600/20 rounded-full backdrop-blur-sm border border-white/20 hover:border-emerald-400/50 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="animate-slide-in-right">
                <div class="relative">
                    <div class="relative bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
                        <img src="{{ asset('assets/hero.png') }}" alt="Premium Indoor Plant" class="w-full h-auto rounded-2xl shadow-2xl">
