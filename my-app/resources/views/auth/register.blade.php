            ...
            <div class="mt-4">
                ...
                <div class="flex items-center gap-6 mt-2">
                    <label class="flex items-center">
                        <input type="radio" name="role" value="customer" class="text-indigo-600 focus:ring-indigo-500 border-gray-300" checked>
                        <span class="ml-2 text-gray-700 dark:text-gray-300">Customer</span>
                    </label>
                    <label class="flex items-center">
                        <input type="radio" name="role" value="seller" class="text-indigo-600 focus:ring-indigo-500 border-gray-300">
